...
export default function EmailVerification() {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      await axios.post('https://cineflow-server-lada.onrender.com/api/verify-email', { email, otp });
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              E-mail Verify to Explore our platform Cine-Flow Movies
            </h2>
            <span
            ...
            >
              ...
              <p className="mb-4 text-center">We've sent a verification code to {email}. Please enter it below:</p>
            </span>
          </div>
          <div
            className="card-body"
